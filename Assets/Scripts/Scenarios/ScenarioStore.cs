...
public static class ScenarioStore
{
	...
	public static readonly Scenario[] Data = 
	{
		...
		new Scenario(false, false, false, 
			"Whilst completing a raid on the home of a suspected people-trafficker, you find a collection of phones stacked together within a drawer. This appears to the only phone which turns on",
			new List<Rule> {
				KeepUnlockedRule
			}),
